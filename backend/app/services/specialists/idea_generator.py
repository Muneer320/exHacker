...
def _fallback_ideas() -> list[dict[str, Any]]:
    """Return fallback ideas when AI generation fails."""
    return [
        {
            ...
            "scores": {"innovation": 70, "feasibility": 80, "demo_potential": 75, "overall": 72},
        ...
        },
        {
            ...
            "scores": {"innovation": 65, "feasibility": 70, "demo_potential": 85, "overall": 70},
            "why_generated": "Fallback — AI generation was unavailable.",
